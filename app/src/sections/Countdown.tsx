...
export function Countdown() {
  ...
  // Launch date: December 31, 2026 (approximately 316 days from now)
  ...
  return (
    <section id="countdown" className="py-20 relative overflow-hidden">
      ...
      {/* Floating orbs */}
      <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-violet-500/20 rounded-full blur-3xl animate-float" />
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        {/* Content card */}
        <div className="bg-white/10 dark:bg-slate-900/50 backdrop-blur-xl rounded-3xl p-8 sm:p-12 border border-white/20 shadow-2xl">
          {/* Badge */}
          ...
          <p className="text-lg text-white/70 text-center mb-10 max-w-xl mx-auto">
            A fantasy world born from the collaboration between human imagination and artificial intelligence.
          ...
          <div className="max-w-md mx-auto">
            ...
            <div className="flex items-center justify-center gap-2 mt-4 text-white/60">
              ...
              <span className="text-sm">
                <span className="font-semibold text-white">2,847</span> people already joined
              </span>
            </div>
          </div>
          ...
          <div className="mt-10 pt-8 border-t border-white/10">
            <div className="grid sm:grid-cols-3 gap-6 text-center">
              {[
                ...
                { label: 'Exclusive Updates', desc: 'Behind-the-scenes content' },
                { label: 'Founder Perks', desc: 'Special rewards at launch' },
              ].map((benefit, index) => (
                <div key={index}>
                  <div className="font-medium text-white mb-1">{benefit.label}</div>
